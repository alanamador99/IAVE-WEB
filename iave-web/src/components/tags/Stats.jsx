...
const configCards = [
  {
    key: 'asignados',
    titulo: 'Asignados',
    descripcion: 'Tags asignados y actualmente en operación',
    bg: 'bg-success',
  ...
  },
  {
    key: 'stock',
    titulo: 'Stock',
    descripcion: 'Tags en stock listos para asignar',
    bg: 'bg-info',
  ...
  },
  {
    key: 'inactivos',
    titulo: 'Inactivos',
    descripcion: 'Tags asignados a personal fuera de operación',
    bg: 'bg-secondary',
  ...
  },
  {
    key: 'extravios',
    titulo: 'Extravíos',
    descripcion: 'Tags extraviados reportados',
    bg: 'bg-danger',
