...
const configCards = [
  {
    ...
    bg: 'bg-warning',
    icon: <AlertTriangle className="h-8 w-8 text-red-500" />, // Este valor se actualizará dinámicamente
    valordefault: 1
  ...
  },
  {
    ...
    bg: 'bg-info',
    icon: <HandCoins  className="h-8 w-8 text-yellow-500" />, // Este valor se actualizará dinámicamente
    valordefault: 2,
  },
  {
    ...
    bg: 'bg-info',
    icon: <Gavel  className="h-8 w-8 text-green-500" />, // Este valor se actualizará dinámicamente
    valordefault: 3,
  },
  {
    key:'completado',
    ...
    bg: 'bg-success',
    icon: <DollarSign className="h-8 w-8 text-blue-500" />, // Este valor se actualizará dinámicamente
    valordefault: '$21,399.00'// Este valor se actualizará dinámicamente
  },
  {
    key:'total',
    ...
    bg: 'bg-dark',
    icon: <CircleCheckBig className="h-8 w-8 text-blue-500" />, // Este valor se actualizará dinámicamente
    valordefault: '$21,399.00'// Este valor se actualizará dinámicamente
  }
];


function StatsAbusos() {
