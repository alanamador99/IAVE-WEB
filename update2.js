...
const endIdx = fileContent.indexOf(tableEndString, startIdx);
...
if (startIdx > -1 && endIdx > -1) {
    ...
    fileContent = fileContent.substring(0, startIdx) + newHeadersStr.trim() + fileContent.substring(endIdx + 8);
